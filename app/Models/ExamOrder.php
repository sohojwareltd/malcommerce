...
class ExamOrder extends Model
{
    ...
    protected static function boot(): void
    {
        ...
        static::creating(function (ExamOrder $order) {
            if (empty($order->order_number)) {
                do {
                    $candidate = 'EX-' . now()->format('Ymd') . '-' . strtoupper(substr(bin2hex(random_bytes(3)), 0, 6));
    ...
    {
        return $this->hasOne(ExamEnrollment::class);
    }
