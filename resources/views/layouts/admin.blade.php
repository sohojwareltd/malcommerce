            ...
            <div class="p-3 sm:p-4">
                ...
                <div class="space-y-1 bg-white/5 rounded-xl py-2 mb-1 border-l-4 border-sky-400">
                    ...
                    <a href="{{ route('admin.sponsors.index') }}" 
                       ...
                       class="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-lg {{ request()->routeIs('admin.sponsors.*') && !request()->routeIs('admin.sponsors.leaderboard') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-sky-500/15' }} transition group relative text-sm sm:text-base"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
