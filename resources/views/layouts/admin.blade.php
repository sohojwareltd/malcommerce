            ...
            <div class="p-3 sm:p-4">
                <div class="flex items-center justify-between mb-4 sm:mb-6">
                    ...
                    <div class="flex gap-2 items-center">
                        <button @click="sidebarCollapsed = !sidebarCollapsed"
                            ...
                            <span class="absolute left-full ml-2 px-2 py-1 bg-neutral-800 text-white text-xs rounded opacity-0 group-hover:opacity-100 pointer-events-none whitespace-nowrap z-50">
                                <span x-show="!sidebarCollapsed">Collapse</span>
                                <span x-show="sidebarCollapsed">Expand</span>
                            </span>
                        </button>
                ...
                <div class="space-y-1">
                    ...
                    <a href="{{ route('admin.purchases.index') }}"
                       ...
                       class="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-lg {{ request()->routeIs('admin.purchases.*') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-white/10' }} transition group relative text-sm sm:text-base"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                        <span x-show="!sidebarCollapsed || window.innerWidth < 1024" class="transition-opacity duration-300">Sponsor purchases</span>
                        <span x-show="sidebarCollapsed && window.innerWidth >= 1024" class="absolute left-full ml-2 px-2 py-1 bg-neutral-800 text-white text-sm rounded opacity-0 group-hover:opacity-100 pointer-events-none whitespace-nowrap z-50">Sponsor purchases</span>
                    </a>
                    @endcan
                </div>
                ...
                <div class="space-y-1 bg-white/5 rounded-xl py-2 mb-1 border-l-4 border-emerald-400">
                    <p x-show="!sidebarCollapsed || window.innerWidth < 1024" class="px-3 text-[11px] font-semibold text-emerald-200 uppercase tracking-wider">Catalog</p>
                    @can('products.viewAny')
                    <a href="{{ route('admin.products.index') }}"
                       :title="sidebarCollapsed && window.innerWidth >= 1024 ? 'Products' : ''"
                       class="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-lg {{ request()->routeIs('admin.products.*') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-emerald-500/15' }} transition group relative text-sm sm:text-base"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.categories.index') }}" 
                       ...
                       class="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-lg {{ request()->routeIs('admin.categories.*') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-emerald-500/15' }} transition group relative text-sm sm:text-base"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.videos.index') }}"
                       :title="sidebarCollapsed && window.innerWidth >= 1024 ? 'Videos' : ''"
                       class="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-lg {{ request()->routeIs('admin.videos.*') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-emerald-500/15' }} transition group relative text-sm sm:text-base"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"></path>
                        </svg>
                        <span x-show="!sidebarCollapsed || window.innerWidth < 1024" class="transition-opacity duration-300">Videos</span>
                ...
                <!-- Sales -->
                @can('orders.viewAny')
                <div class="space-y-1 bg-white/5 rounded-xl py-2 mb-1 border-l-4 border-indigo-400">
                    <p x-show="!sidebarCollapsed || window.innerWidth < 1024" class="px-3 text-[11px] font-semibold text-indigo-200 uppercase tracking-wider">Sales</p>
                    <a href="{{ route('admin.orders.index') }}"
                       :title="sidebarCollapsed && window.innerWidth >= 1024 ? 'All Orders' : ''"
                       class="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg {{ request()->routeIs('admin.orders.index') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-indigo-500/15' }} transition group relative text-xs sm:text-sm"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                    ...
                    <a href="{{ route('admin.orders.physical') }}"
                       ...
                       class="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg {{ request()->routeIs('admin.orders.physical') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-indigo-500/15' }} transition group relative text-xs sm:text-sm"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.orders.digital') }}"
                       ...
                       class="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg {{ request()->routeIs('admin.orders.digital') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-indigo-500/15' }} transition group relative text-xs sm:text-sm"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="space-y-1 bg-white/5 rounded-xl py-2 mb-1 border-l-4 border-sky-400">
                    <p x-show="!sidebarCollapsed || window.innerWidth < 1024" class="px-3 text-[11px] font-semibold text-sky-200 uppercase tracking-wider">Affiliates</p>
                    <a href="{{ route('admin.sponsors.index') }}" 
                       :title="sidebarCollapsed && window.innerWidth >= 1024 ? 'Sponsors' : ''"
                       class="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-lg {{ request()->routeIs('admin.sponsors.*') && !request()->routeIs('admin.sponsors.leaderboard', 'admin.sponsors.pending-earnings', 'admin.sponsors.by-balance') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-sky-500/15' }} transition group relative text-sm sm:text-base"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.sponsors.by-balance') }}"
                       :title="sidebarCollapsed && window.innerWidth >= 1024 ? 'Partners by balance' : ''"
                       class="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-lg {{ request()->routeIs('admin.sponsors.by-balance') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-sky-500/15' }} transition group relative text-sm sm:text-base"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                        <span x-show="!sidebarCollapsed || window.innerWidth < 1024" class="transition-opacity duration-300">Partners by balance</span>
                        <span x-show="sidebarCollapsed && window.innerWidth >= 1024" class="absolute left-full ml-2 px-2 py-1 bg-neutral-800 text-white text-sm rounded opacity-0 group-hover:opacity-100 pointer-events-none whitespace-nowrap z-50">Partners by balance</span>
                    </a>
                    <a href="{{ route('admin.sponsors.leaderboard') }}"
                       :title="sidebarCollapsed && window.innerWidth >= 1024 ? 'Sponsor leaderboard' : ''"
                       class="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-lg {{ request()->routeIs('admin.sponsors.leaderboard') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-sky-500/15' }} transition group relative text-sm sm:text-base"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 20V10m5 10V4m5 16v-7"></path>
                        </svg>
                    ...
                    <a href="{{ route('admin.purchases.index', ['status' => 'pending']) }}"
                       :title="sidebarCollapsed && window.innerWidth >= 1024 ? 'Sponsor purchases' : ''"
                       class="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-lg {{ request()->routeIs('admin.purchases.*') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-sky-500/15' }} transition group relative text-sm sm:text-base"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                    ...
                    @endcan
                    @can('viewAny', \App\Models\SponsorLevel::class)
                    <a href="{{ route('admin.sponsor-levels.index') }}"
                       :title="sidebarCollapsed && window.innerWidth >= 1024 ? 'Sponsor levels' : ''"
                       class="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-lg {{ request()->routeIs('admin.sponsor-levels.*') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-sky-500/15' }} transition group relative text-sm sm:text-base"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 11l5-5m0 0l5 5m-5-5v12"></path>
                        </svg>
                        <span x-show="!sidebarCollapsed || window.innerWidth < 1024" class="transition-opacity duration-300">Sponsor levels</span>
                        <span x-show="sidebarCollapsed && window.innerWidth >= 1024" class="absolute left-full ml-2 px-2 py-1 bg-neutral-800 text-white text-sm rounded opacity-0 group-hover:opacity-100 pointer-events-none whitespace-nowrap z-50">Sponsor levels</span>
                    </a>
                    @endcan
                </div>
                @endcan
                ...
                <div class="space-y-1 bg-white/5 rounded-xl py-2 mb-1 border-l-4 border-fuchsia-400">
                    <p x-show="!sidebarCollapsed || window.innerWidth < 1024" class="px-3 text-[11px] font-semibold text-fuchsia-200 uppercase tracking-wider">Jobs & Workshops</p>
                    ...
                    <a href="{{ route('admin.job-circulars.index') }}"
                       ...
                       class="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-lg {{ request()->routeIs('admin.job-circulars.*') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-fuchsia-500/15' }} transition group relative text-sm sm:text-base"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.job-applications.index') }}"
                       ...
                       class="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-lg {{ request()->routeIs('admin.job-applications.*') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-fuchsia-500/15' }} transition group relative text-sm sm:text-base"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.venues.index') }}"
                       :title="sidebarCollapsed && window.innerWidth >= 1024 ? 'Venues' : ''"
                       class="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-lg {{ request()->routeIs('admin.venues.*') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-fuchsia-500/15' }} transition group relative text-sm sm:text-base"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                        <span x-show="!sidebarCollapsed || window.innerWidth < 1024" class="transition-opacity duration-300">Venues</span>
                        <span x-show="sidebarCollapsed && window.innerWidth >= 1024" class="absolute left-full ml-2 px-2 py-1 bg-neutral-800 text-white text-sm rounded opacity-0 group-hover:opacity-100 pointer-events-none whitespace-nowrap z-50">Venues</span>
                    </a>
                    <a href="{{ route('admin.trades.index') }}"
                       :title="sidebarCollapsed && window.innerWidth >= 1024 ? 'Trades' : ''"
                       class="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-lg {{ request()->routeIs('admin.trades.*') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-fuchsia-500/15' }} transition group relative text-sm sm:text-base"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z"></path></svg>
                        <span x-show="!sidebarCollapsed || window.innerWidth >= 1024" class="transition-opacity duration-300">Trades</span>
                        <span x-show="sidebarCollapsed && window.innerWidth >= 1024" class="absolute left-full ml-2 px-2 py-1 bg-neutral-800 text-white text-sm rounded opacity-0 group-hover:opacity-100 pointer-events-none whitespace-nowrap z-50">Trades</span>
                    </a>
                    <a href="{{ route('admin.workshop-seminars.index') }}"
                       :title="sidebarCollapsed && window.innerWidth >= 1024 ? 'Workshops' : ''"
                       class="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-lg {{ request()->routeIs('admin.workshop-seminars.*') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-fuchsia-500/15' }} transition group relative text-sm sm:text-base"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.workshop-enrollments.index') }}"
                       ...
                       class="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-lg {{ request()->routeIs('admin.workshop-enrollments.*') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-fuchsia-500/15' }} transition group relative text-sm sm:text-base"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="space-y-1 bg-white/5 rounded-xl py-2 mb-1 border-l-4 border-amber-400">
                    <p x-show="!sidebarCollapsed || window.innerWidth < 1024" class="px-3 text-[11px] font-semibold text-amber-200 uppercase tracking-wider">Finance</p>
                    @can('withdrawals.viewAny')
                    <a href="{{ route('admin.withdrawals.index') }}" 
                       :title="sidebarCollapsed && window.innerWidth >= 1024 ? 'Withdrawals' : ''"
                       class="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-lg {{ request()->routeIs('admin.withdrawals.*') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-amber-500/15' }} transition group relative text-sm sm:text-base"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.expenses.index') }}"
                       ...
                       class="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-lg {{ request()->routeIs('admin.expenses.*') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-amber-500/15' }} transition group relative text-sm sm:text-base"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.expense-categories.index') }}"
                       :title="sidebarCollapsed && window.innerWidth >= 1024 ? 'Expense Categories' : ''"
                       class="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-lg {{ request()->routeIs('admin.expense-categories.*') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-amber-500/15' }} transition group relative text-sm sm:text-base"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 10h10M4 14h7M4 18h16"></path>
                        </svg>
                        <span x-show="!sidebarCollapsed || window.innerWidth < 1024" class="transition-opacity duration-300">Expense Categories</span>
                        <span x-show="sidebarCollapsed && window.innerWidth >= 1024" class="absolute left-full ml-2 px-2 py-1 bg-neutral-800 text-white text-sm rounded opacity-0 group-hover:opacity-100 pointer-events-none whitespace-nowrap z-50">Expense Categories</span>
                    </a>
                    @endcan
                </div>
                @endif
                ...
                <!-- Reports -->
                @can('reports.sales')
                <div class="space-y-1 bg-white/5 rounded-xl py-2 mb-1 border-l-4 border-teal-400">
                    <p x-show="!sidebarCollapsed || window.innerWidth < 1024" class="px-3 text-[11px] font-semibold text-teal-200 uppercase tracking-wider">Reports</p>
                    <a href="{{ route('admin.reports.sales') }}" 
                       :title="sidebarCollapsed && window.innerWidth >= 1024 ? 'Sales Report' : ''"
                       class="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-lg {{ request()->routeIs('admin.reports.*') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-teal-500/15' }} transition group relative text-sm sm:text-base"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="space-y-1 bg-white/5 rounded-xl py-2 mb-1 border-l-4 border-rose-400">
                    <p x-show="!sidebarCollapsed || window.innerWidth < 1024" class="px-3 text-[11px] font-semibold text-rose-200 uppercase tracking-wider">Users & Access</p>
                    @can('users.viewAny')
                    <a href="{{ route('admin.users.index') }}"
                       :title="sidebarCollapsed && window.innerWidth >= 1024 ? 'Admin Users' : ''"
                       class="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-lg {{ request()->routeIs('admin.users.*') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-rose-500/15' }} transition group relative text-sm sm:text-base"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.roles.index') }}"
                       :title="sidebarCollapsed && window.innerWidth >= 1024 ? 'Roles' : ''"
                       class="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-lg {{ request()->routeIs('admin.roles.*') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-rose-500/15' }} transition group relative text-sm sm:text-base"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path>
                        </svg>
                        <span x-show="!sidebarCollapsed || window.innerWidth < 1024" class="transition-opacity duration-300">Roles</span>
                ...
                <!-- Account -->
                <div class="space-y-1 bg-white/5 rounded-xl py-2 mt-2 border-l-4 border-cyan-400">
                    <p x-show="!sidebarCollapsed || window.innerWidth < 1024" class="px-3 text-[11px] font-semibold text-cyan-200 uppercase tracking-wider">Account</p>
                    @can('profile.view')
                    <a href="{{ route('admin.profile.edit') }}"
                       :title="sidebarCollapsed && window.innerWidth >= 1024 ? 'Profile' : ''"
                       class="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-lg {{ request()->routeIs('admin.profile.*') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-cyan-500/15' }} transition group relative text-sm sm:text-base"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @endcan
                    @can('settings.view')
                    <a href="{{ route('admin.steadfast-attempts.index') }}"
                       :title="sidebarCollapsed && window.innerWidth >= 1024 ? 'Steadfast Logs' : ''"
                       class="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-lg {{ request()->routeIs('admin.steadfast-attempts.*') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-cyan-500/15' }} transition group relative text-sm sm:text-base"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
                        </svg>
                        <span x-show="!sidebarCollapsed || window.innerWidth < 1024" class="transition-opacity duration-300">Steadfast Logs</span>
                        <span x-show="sidebarCollapsed && window.innerWidth >= 1024" class="absolute left-full ml-2 px-2 py-1 bg-neutral-800 text-white text-sm rounded opacity-0 group-hover:opacity-100 pointer-events-none whitespace-nowrap z-50">Steadfast Logs</span>
                    </a>
                    @can('settings.smsSend')
                    <a href="{{ route('admin.settings.sms-send') }}"
                       :title="sidebarCollapsed && window.innerWidth >= 1024 ? 'Send SMS' : ''"
                       class="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-lg {{ request()->routeIs('admin.settings.sms-send*') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-cyan-500/15' }} transition group relative text-sm sm:text-base"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                        </svg>
                        <span x-show="!sidebarCollapsed || window.innerWidth < 1024" class="transition-opacity duration-300">Send SMS</span>
                        <span x-show="sidebarCollapsed && window.innerWidth >= 1024" class="absolute left-full ml-2 px-2 py-1 bg-neutral-800 text-white text-sm rounded opacity-0 group-hover:opacity-100 pointer-events-none whitespace-nowrap z-50">Send SMS</span>
                    </a>
                    @endcan
                    <a href="{{ route('admin.settings') }}" 
                       :title="sidebarCollapsed && window.innerWidth >= 1024 ? 'Settings' : ''"
                       class="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-lg {{ request()->routeIs('admin.settings') && !request()->routeIs('admin.settings.sms-send*') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-white/10' }} transition group relative text-sm sm:text-base"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
