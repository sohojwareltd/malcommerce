...
<body class="h-full bg-gradient-to-br from-neutral-50 to-neutral-100 font-sans" x-data="{ sidebarOpen: window.innerWidth >= 1024, sidebarCollapsed: false }">
    <div class="min-h-full flex">
        ...
        <aside :class="[
            ...
            sidebarCollapsed && window.innerWidth >= 1024 ? 'lg:w-20' : 'lg:w-64'
               ...
               class="bg-gradient-to-b from-primary to-primary-light shadow-xl border-r border-primary/20 fixed h-full overflow-y-auto z-50 transition-all duration-300 ease-in-out">
            <div class="p-4">
                <div class="flex items-center justify-between mb-6">
                    <h2 x-show="!sidebarCollapsed || window.innerWidth < 1024" class="text-xl font-bold text-white transition-opacity duration-300">Admin Panel</h2>
                    <div class="flex gap-2">
                        ...
                        <button @click="sidebarOpen = false" class="lg:hidden text-white hover:text-neutral-200">
                ...
                <nav class="space-y-2">
                    <a href="{{ route('admin.dashboard') }}" 
                       ...
                       class="flex items-center gap-3 px-4 py-3 rounded-lg {{ request()->routeIs('admin.dashboard') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-white/10' }} transition group relative"
                    ...
                    <a href="{{ route('admin.products.index') }}" 
                       ...
                       class="flex items-center gap-3 px-4 py-3 rounded-lg {{ request()->routeIs('admin.products.*') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-white/10' }} transition group relative"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.categories.index') }}" 
                       ...
                       class="flex items-center gap-3 px-4 py-3 rounded-lg {{ request()->routeIs('admin.categories.*') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-white/10' }} transition group relative"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.orders.index') }}" 
                       ...
                       class="flex items-center gap-3 px-4 py-3 rounded-lg {{ request()->routeIs('admin.orders.*') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-white/10' }} transition group relative"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.sponsors.index') }}" 
                       ...
                       class="flex items-center gap-3 px-4 py-3 rounded-lg {{ request()->routeIs('admin.sponsors.*') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-white/10' }} transition group relative"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.reports.sales') }}" 
                       ...
                       class="flex items-center gap-3 px-4 py-3 rounded-lg {{ request()->routeIs('admin.reports.*') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-white/10' }} transition group relative"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.settings') }}" 
                       ...
                       class="flex items-center gap-3 px-4 py-3 rounded-lg {{ request()->routeIs('admin.settings') ? 'bg-white text-primary shadow-lg' : 'text-white/90 hover:bg-white/10' }} transition group relative"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('home') }}" 
                       ...
                       class="flex items-center gap-3 px-4 py-3 rounded-lg text-white/90 hover:bg-white/10 transition group relative"
                       :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                    ...
                    <form method="POST" action="{{ route('logout') }}" class="pt-2">
                        ...
                        <button type="submit" 
                                ...
                                class="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-white/90 hover:bg-red-500/20 transition group relative"
                                :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'justify-center' : ''">
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Main Content -->
        <main :class="sidebarCollapsed && window.innerWidth >= 1024 ? 'lg:ml-20' : 'lg:ml-64'" class="flex-1 transition-all duration-300">
            <!-- Top Bar -->
            <div class="bg-white shadow-sm border-b border-neutral-200 sticky top-0 z-30">
                <div class="px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
                    <button @click="sidebarOpen = !sidebarOpen" class="lg:hidden text-neutral-700 hover:text-primary">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path>
                        </svg>
                    </button>
                    <h1 class="text-2xl font-bold text-neutral-800">@yield('title', 'Dashboard')</h1>
                    <div class="w-6"></div>
                </div>
            </div>
