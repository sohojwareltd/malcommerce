...
<div class="max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="bg-white rounded-lg shadow-lg p-8">
        <h2 class="text-2xl font-bold text-center mb-6 font-bangla">রেজিস্টার করুন</h2>
        
        <div id="name-phone-step">
            <form id="send-otp-form">
                @csrf
                
                <div class="mb-4">
                    <label for="name" class="block text-sm font-medium text-neutral-700 mb-2 font-bangla">নাম</label>
        ...
        <div id="otp-step" class="hidden">
            <div class="mb-4">
                <p class="text-sm text-neutral-700 mb-2 font-bangla">
        ...
        <p class="mt-6 text-center text-sm text-neutral-600 font-bangla">
            ইতিমধ্যে একাউন্ট আছে? <a href="{{ route('login') }}" class="text-primary hover:underline">লগইন করুন</a>
        </p>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    const namePhoneStep = document.getElementById('name-phone-step');
    ...
    sendOtpForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            if (data.success) {
                namePhoneStep.classList.add('hidden');
