...
<div class="max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="bg-white rounded-lg shadow-lg p-8">
        <h2 class="text-2xl font-bold text-center mb-6 font-bangla">পাসওয়ার্ড রিসেট করুন</h2>
        ...
        <div id="phone-step">
            <p class="text-sm text-neutral-600 mb-6 text-center font-bangla">
                আপনার ফোন নম্বর দিন। আমরা আপনার নম্বরে OTP পাঠাবো।
            </p>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    verifyOtpForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            if (data.success) {
                window.location.href = data.redirect || '{{ route("password.reset") }}';
            } else {
