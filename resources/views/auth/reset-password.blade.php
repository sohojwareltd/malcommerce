    ...
    <div class="bg-white rounded-lg shadow-lg p-8">
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="mb-4">
                ...
                <p class="mt-1 text-xs text-neutral-500 font-bangla">পাসওয়ার্ড কমপক্ষে ৬ অক্ষরের হতে হবে</p>
                @error('password')
            ...
            <div class="mb-4">
                ...
                <div class="relative">
                    <input type="password" name="password_confirmation" id="password_confirmation" required 
                           ...
                           minlength="8"
                           class="w-full px-4 py-2 pr-12 border {{ $errors->has('password_confirmation') ? 'border-red-500' : 'border-neutral-300' }} rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">
