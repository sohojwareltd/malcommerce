...
<div class="mb-4 sm:mb-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl sm:text-3xl font-bold">Add Expense Category</h1>
            <p class="text-neutral-600 mt-1 sm:mt-2 text-sm sm:text-base">Create a new expense category</p>
        </div>
