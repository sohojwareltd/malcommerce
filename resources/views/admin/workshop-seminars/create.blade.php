...
<div class="bg-white rounded-lg shadow-md p-4 sm:p-6 w-full lg:max-w-[50%] lg:min-w-[32rem]">
    <form method="POST" action="{{ route('admin.workshop-seminars.store') }}" enctype="multipart/form-data" class="space-y-6">
        ...
        <div>
            ...
            <div class="space-y-2 border border-neutral-200 rounded-lg p-3 max-h-40 overflow-y-auto">
                ...
                <label class="flex items-center gap-2">
                    <input type="checkbox" name="venues[]" value="{{ $v->id }}" class="venue-cb rounded" {{ in_array($v->id, old('venues', [])) ? 'checked' : '' }}>
        ...
        <div>
            ...
            <input type="text" name="venue" id="venue" value="{{ old('venue') }}" placeholder="Optional extra venue text"
        ...
        <div id="workshop-trades-wrap" class="hidden">
            ...
            <p class="text-xs text-neutral-500 mb-2">Select which trades are available (only trades from the selected venues are listed).</p>
        ...
        <div class="border-t border-neutral-200 pt-4">
            ...
            <p class="text-xs text-neutral-500 mb-3">Choose which fields to show on the public enrollment form. Name is always required.</p>
            <div class="space-y-2">
                <label class="flex items-center gap-2">
                    <input type="checkbox" name="show_phone" value="1" {{ old('show_phone', true) ? 'checked' : '' }} class="rounded">
                ...
                <label class="flex items-center gap-2">
                    <input type="checkbox" name="show_notes" value="1" {{ old('show_notes', true) ? 'checked' : '' }} class="rounded">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function renderTradesForVenues() {
        ...
        allTrades.forEach(function(t) {
            ...
            var checked = oldTrades.indexOf(String(t.id)) !== -1 ? ' checked' : '';
