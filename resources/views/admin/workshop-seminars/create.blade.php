    ...
    <form method="POST" action="{{ route('admin.workshop-seminars.store') }}" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="text" name="venue" id="venue" value="{{ old('venue') }}" placeholder="Optional if venue selected above"
        ...
        <div id="workshop-trades-wrap" class="hidden">
            ...
            <p class="text-xs text-neutral-500 mb-2">Select which trades are available for this workshop (only trades assigned to the selected venue are listed).</p>
