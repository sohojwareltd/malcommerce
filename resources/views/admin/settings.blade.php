            ...
            <div class="border-t border-neutral-200 pt-6 mt-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="rounded-lg bg-neutral-50 p-4 border border-neutral-200">
                        <p class="text-sm font-medium text-neutral-700 mb-1">Webhook URL (for delivery status & tracking updates)</p>
                        <code class="text-sm break-all select-all">{{ url('/webhooks/steadfast') }}</code>
                        <p class="text-xs text-neutral-500 mt-2">Configure this URL in Steadfast/Packzy portal. If API Key is set, include <code>Authorization: Bearer {api_key}</code> header.</p>
                    </div>
                </div>
            </div>
            <div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <p class="text-xs text-neutral-500 mt-1">Enter your Google Analytics (GA4) measurement ID</p>
            </div>
            <div>
                <label class="block text-sm font-medium text-neutral-700 mb-2">Google Tag Manager Container ID</label>
                <input type="text" name="gtm_container_id" value="{{ \App\Models\Setting::get('gtm_container_id') }}" placeholder="GTM-XXXXXXX" class="w-full px-4 py-2 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-primary">
                <p class="text-xs text-neutral-500 mt-1">Enter your GTM container ID (e.g. GTM-XXXXXXX). You can then manage GA, Facebook Pixel, and other tags from GTM.</p>
            </div>
        </div>
    </div>
    </div>
