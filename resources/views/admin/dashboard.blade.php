...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl shadow-lg p-6 text-white transform hover:scale-105 transition-transform duration-200">
        ...
        <h3 class="text-white/80 text-sm font-medium mb-1">Pending Orders</h3>
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
    <div class="bg-gradient-to-br from-pink-500 to-pink-600 rounded-xl shadow-lg p-6 text-white">
        ...
        <h3 class="text-white/80 text-sm font-medium mb-1">Sponsors</h3>
        <p class="text-4xl font-bold">{{ $stats['total_sponsors'] }}</p>
    </div>
    ...
    <div class="bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-xl shadow-lg p-6 text-white">
        ...
        <h3 class="text-white/80 text-sm font-medium mb-1">Growth Rate</h3>
    ...
    <div class="bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-xl shadow-lg p-6 text-white">
        ...
        <h3 class="text-white/80 text-sm font-medium mb-1">Avg Order Value</h3>
        <p class="text-4xl font-bold">৳{{ number_format($stats['total_revenue'] / max($stats['total_orders'], 1), 2) }}</p>
    </div>
</div>
