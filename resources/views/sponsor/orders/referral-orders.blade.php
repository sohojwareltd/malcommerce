...
<div class="min-h-screen pb-6" style="">
    ...
    <div class="app-card mx-4 mt-4 mb-4 p-4">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div>
                <h1 class="text-base sm:text-lg md:text-xl font-bold" style="color: var(--color-dark);">Referral Orders</h1>
                <p class="text-xs sm:text-sm mt-1" style="color: var(--color-medium);">Orders from your referrals (these count as revenue)</p>
            </div>
            <a href="{{ route('sponsor.orders.my-orders') }}" 
               class="px-4 py-2 rounded-lg text-white text-xs sm:text-sm font-semibold whitespace-nowrap" 
    ...
    <!-- Stats Cards -->
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 px-4 mb-4">
        ...
        <div class="stat-card text-center" style="background: linear-gradient(135deg, #10B981 0%, #059669 100%);">
            ...
            <p class="text-base sm:text-lg md:text-xl font-bold text-white">৳{{ number_format($stats['total_revenue'] ?? 0, 2) }}</p>
        </div>
