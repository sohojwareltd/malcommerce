...
<div class="min-h-screen pb-6" style="">
    ...
    <div class="app-card mx-4 mb-4 overflow-hidden">
        ...
        <!-- Mobile layout: cards (same as sponsor dashboard) -->
                ...
                <div class="p-3 rounded-2xl border-2 hover:shadow-md transition bg-white" style="border-color: var(--color-accent);">
                    <div class="flex gap-3">
                        ...
                        <div class="w-28 flex-shrink-0">
                            ...
                            @else
                                <div class="w-full h-24 rounded-xl flex items-center justify-center" style="background: var(--color-light);">
                            ...
                            <div class="flex items-center justify-between mt-2">
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <a href="{{ route('sponsor.users.edit', $referral) }}"
                                       class="text-xs font-semibold px-3 py-1 rounded-full border border-dashed"
                                       style="color: var(--color-light); border-color: var(--color-light);">
                                        Edit
                                    </a>
                                </div>
                            </div>
