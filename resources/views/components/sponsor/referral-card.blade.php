<div class="p-3 rounded-2xl border-2 hover:shadow-md transition bg-white" style="border-color: var(--color-accent);">
    ...
    <div class="grid grid-cols-5 sm:grid-cols-6 md:grid-cols-5 gap-3">
        ...
        {{-- Row 3: Buttons spanning full width --}}
        <div class="col-span-5 sm:col-span-6 md:col-span-5 flex items-center justify-end gap-2 mt-4 pt-3 border-t border-gray-100 flex-wrap">
            @if($referral->phone)
